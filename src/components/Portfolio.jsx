...
const Portfolio = () => {
  const projects = [
    {
      title: "J.A.T.E",
      link: "https://j-a-t-e-utrp.onrender.com/",
      repo: "https://github.com/CameronGillum/J.A.T.E",
      svg: (
    ...
    },
    {
      ...
      repo: "https://github.com/CameronGillum/ReadME-Generator",
      svg: (
    ...
    },
    {
      ...
      link: "https://camerongillum.github.io/5-day-weather-forecast/",
      repo: "https://github.com/CameronGillum/5-day-weather-forecast",
      svg: (
    ...
    },
    {
      ...
      repo: "https://github.com/CameronGillum/social-media-startup",
      svg: (
    ...
    },
    {
      ...
      repo: "https://github.com/CameronGillum/e-commerce-back-end",
      svg: (
    ...
    },
    {
      ...
      link: "https://camerongillum.github.io/blog-post-project/",
      repo: "https://github.com/CameronGillum/blog-post-project",
      svg: (
        <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-chat-left-dots" viewBox="0 0 16 16">
    ...
    <section className="portfolio">
      {projects.map((project, index) => (
        <div className="card" key={index}>
          {project.svg}
          <h3>{project.title}</h3>
          {project.link && <a href={project.link}>Deployed App</a>}
